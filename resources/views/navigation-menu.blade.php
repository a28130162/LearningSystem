                ...
                @auth
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        @if (Auth::user()->role == 'admin')
                            <x-jet-nav-link href="{{ route('management') }}" :active="request()->routeIs('management')">
                                {{ __('管理列表') }}
                            </x-jet-nav-link>
                            ...
                            <x-jet-nav-link href="{{ route('course') }}" :active="request()->routeIs('course')">
                                {{ __('課程管理') }}
                            </x-jet-nav-link>
                            ...
                            <x-jet-nav-link href="{{ route('comment_paper') }}"
                                :active="request()->routeIs('comment_paper')">
                                {{ __('評論試卷管理') }}
                            </x-jet-nav-link>
            ...
            <div class="pt-2 pb-3 space-y-1">
                @if (Auth::user()->role == 'admin')
                    <x-jet-responsive-nav-link href="{{ route('management') }}"
                        :active="request()->routeIs('management')">
                        {{ __('管理列表') }}
                    ...
                    <x-jet-responsive-nav-link href="{{ route('question') }}" :active="request()->routeIs('question')">
                        {{ __('個案管理') }}
                    </x-jet-responsive-nav-link>
                    <x-jet-responsive-nav-link href="{{ route('comment_paper') }}"
                        :active="request()->routeIs('comment_paper')">
                        {{ __('評論試卷管理') }}
                    </x-jet-responsive-nav-link>
                    <x-jet-responsive-nav-link href="{{ route('record') }}" :active="request()->routeIs('record')">
                        {{ __('作答紀錄管理') }}
                    </x-jet-responsive-nav-link>
                @elseif (Auth::user()->role == 'teacher')
                    <x-jet-responsive-nav-link href="{{ route('course') }}" :active="request()->routeIs('course')">
